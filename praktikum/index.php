 ...
 <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
    ...
    <section class="home" id="home">
      <div class="jumbotron jumbotron-fluid bg-success">
          <div class="container">
              <h1 class="display-4"><span>WELCOME</span> <br> To Main Home Index.</h1>
          </div>
      </div>
    </section>
    <!-- akhir jumbotron -->
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">P5_PW_193040023</h5>
        <p class="card-text">Klik link dibawah untuk menuju halaman Praktikum 5.</p>
        <a href="P5_PW_193040023" class="btn btn-primary">Link</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">P6_PW_193040023</h5>
        <p class="card-text">Klik link dibawah untuk menuju halaman Praktikum 6.</p>
        <a href="P6_PW_193040023" class="btn btn-primary">Link</a>
      </div>
    </div>
  </div>
</div>
    <div class="card mt-5 mb-5">
      <div class="card-body">
        <h5 class="card-title">P7_PW_193040023</h5>
        <p class="card-text">Klik link dibawah untuk menuju halaman Praktikum 7.</p>
        <a href="P7_PW_193040023" class="btn btn-primary">Link</a>
      </div>
    </div>
  </div>
</div>
